...
book_writing_agent = Agent(
    ...
    instructions="""You are an expert technical writer and research assistant.
Your goal is to analyze video transcripts and extract key information, structuring it into sections for a technical book.

Given a video transcript, your task is to identify relevant topics. For each topic, you must structure your output as a list of 'BookSection' objects. Each object should contain:
